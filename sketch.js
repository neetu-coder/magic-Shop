...
if(gameState === "start"){
   ...
   //title
    fill("white")
    textSize(90)
    text(" Magic Shop",width/2-300,200);

    //story;
    fill ("white")
    textSize(24);
    text("When you feel like disappearing and feel lonely, Magic shop is the place where you can feel happy. ",50,height/2)
    text(" You can open the door of the magic shop I will be here waiting for you. .",50,height/2+50)
    text(" But oh no, the magic shop has been invaded by the monsters and asks your help to get it back.",50,height-200)
    text("Please ENTER to start",width/2-180,height-100);
...
stroke("50")
fill("red") 
text ("Monsters ="+score,windowWidth-400,50)
text ("People killed="+escaped,windowWidth-400,100)
...
function(inputValue){ if(inputValue == "are you asleep yet?") {swal("Correct", "Your way is cleared.", "success");playerMoving=false} else {
...
inputPlaceholder : " Type your answer here", confirmButtonText: "Ok",
closeOnConfirm: false },
function(inputValue){ if(inputValue == "candle") {swal("Correct", "Your way is cleared.", "success");playerMoving=false} else {
swal.showInputError("incorrect Answer!");
}});
mon3.destroy()
...
inputPlaceholder : " Type your answer here", confirmButtonText: "Ok",
closeOnConfirm: false},
function(inputValue){ if(inputValue == "piano") {swal("Correct", "Your way is cleared.", "success");playerMoving=false} else {
swal.showInputError("incorrect Answer!");
}});
...
inputPlaceholder : " Type your answer here", confirmButtonText: "Ok",
closeOnConfirm: false },
function(inputValue){ if(inputValue == "age") {swal("Correct", "Your way is cleared.", "success");playerMoving=false} else {
swal.showInputError("incorrect Answer!");
}});
mon2.destroy ()
}
...
inputPlaceholder : " Type your answer here", confirmButtonText: "Ok",
closeOnConfirm: false },
function(inputValue){ if(inputValue == "dictionary") {swal("Correct", "Your way is cleared.", "success");playerMoving=false} else {
swal.showInputError("incorrect Answer!");
}});
...
inputPlaceholder : " Type your answer here", confirmButtonText: "Ok",
closeOnConfirm: false },
function(inputValue){ if(inputValue == "g"){ swal("Correct", "Your way is cleared.", "success");playerMoving=false} else {
swal.showInputError("incorrect Answer!");
}});
mon6.destroy ()
}
